...
router.get('/ingresoHoras', isLoggedIn, async (req, res) => {
    ...
    try {
       ...
       const proyectos = await pool.query(" SELECT  " +
        ...
        // ocurrio un problema.
        mensajeria.MensajerErrores("\n\n Archivo : bitacora.js \n Error en el directorio: /ingresoHoras \n" + error + "\n Generado por : " + req.user.login);
...
router.post('/cargaOpcionesEtapa', isLoggedIn, async (req, res) => {
    ...
    try {
       ...
       // ocurrio un problema.
       mensajeria.MensajerErrores("\n\n Archivo : bitacora.js \n Error en el directorio: /cargaOpcionesEtapa \n" + error + "\n Generado por : " + req.user.login);
       res.redirect(   url.format({
           pathname:'/dashboard',
                   query: {
                   "a": 1
...
router.post('/eliminarHoras', isLoggedIn, async (req, res) => {
    ...
    try {
        ...
        mensajeria.MensajerErrores("\n\n Archivo : bitacora.js \n Error en el directorio: /eliminarHoras \n" + error + "\n Generado por : " + req.user.login);
       res.redirect(   url.format({
           pathname:'/dashboard',
                   query: {
                   "a": 1
...
router.post('/cargarHoras', isLoggedIn, async (req, res) => {
    ...
    try {
        ...
        mensajeria.MensajerErrores("\n\n Archivo : bitacora.js \n Error en el directorio: /cargarHoras \n" + error + "\n Generado por : " + req.user.login);
        res.redirect(   url.format({
            pathname:'/dashboard',
                    query: {
                    "a": 1
...
router.get('/getBitacora', isLoggedIn, async (req,res) => {
   ...
   res.send(HorasRegsitradas);
        ...
        mensajeria.MensajerErrores("\n\n Archivo : bitacora.js \n Error en el directorio: /getBitacora \n" + error + "\n Generado por : " + req.user.login);
        res.redirect(   url.format({
            pathname:'/dashboard',
                    query: {
                    "a": 1
